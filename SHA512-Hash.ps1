# bismarck-otto 2025-12-01 to calculate hash with SHA512-Hash.ps1
...
#    powershell.exe -ExecutionPolicy Bypass -File "C:\Path\To\SHA512-Hash.ps1"
# d) Replace C:\Path\To\ with the actual path to your SHA512-Hash.ps1 file.
# e) Name it something like SHA512 Hash.
...
[System.Windows.Forms.Clipboard]::SetText("sha512:$lowerHash")
...
$formattedHash = $spacedHash

# Output to messagebox
[System.Windows.Forms.MessageBox]::Show(
    "SHA512 hash of $fileName`n`n$formattedHash",
    "SHA512 Hash", 0
)
